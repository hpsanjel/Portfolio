...
export default function Footer() {
    return (
        <footer className="relative mt-20 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-purple-950 dark:via-blue-950 dark:to-gray-950 border-t border-gray-200 dark:border-purple-900/50">
            {/* Background Pattern */}

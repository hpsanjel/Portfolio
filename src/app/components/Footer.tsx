...
export default function Footer() {
    return (
        <footer className="relative md:mt-6 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-black dark:via-blue-950/90 dark:to-gray-950 border-t border-gray-200 dark:border-purple-900/50">
            {/* Background Pattern */}

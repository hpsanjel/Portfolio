                    ...
                    <div className="sm:col-span-2 md:col-span-2 text-center sm:text-left">
                        <Link href="/" className="group inline-flex items-center gap-3 mb-4">
                            <Image
                                ...
                                width={1402}
                                height={881}
                                className="w-20 transition-transform duration-300 group-hover:scale-105 dark:filter-[drop-shadow(1px_0_0_#fff)_drop-shadow(-1px_0_0_#fff)_drop-shadow(0_1px_0_#fff)_drop-shadow(0_-1px_0_#fff)]"
                            />
                        </Link>
                        <p className="text-sm text-gray-600 dark:text-gray-400 max-w-sm mx-auto sm:mx-0 leading-relaxed">
                        ...
                        <div className="flex justify-center sm:justify-start gap-3">
                            {socialLinks.map((social) => (
                                <a
                                    ...
                                    className="rounded-lg bg-gray-100 dark:bg-white p-2 hover:bg-yellow-100 dark:hover:bg-gray-200 transition-all duration-300 hover:scale-110"

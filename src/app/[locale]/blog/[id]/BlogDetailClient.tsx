              ...
              <article className="bg-white dark:bg-gray-800 rounded-lg shadow-sm overflow-hidden">
                <div className="p-4 md:p-8">
                    ...
                    <div className="flex flex-wrap items-center gap-1 sm:gap-2 text-sm text-gray-600 dark:text-gray-400 md:mb-6">
                      <span className="font-semibold">{t("byAuthor")} <a href="https://www.facebook.com/hpsanjel" className="text-gray-700 hover:text-gray-600 dark:text-gray-300 dark:hover:text-gray-400">{blog.author}</a></span>
                      ...
                      <span className="flex items-center">
                        ...
                        {t("minRead", { minutes: calculateReadingTime(blog.content) })}
                      </span>
